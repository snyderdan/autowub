...
//		}
	...
	public void createBass(){
		...
		bassLine[0] = new Note(trackRhythm.get(0),pickNoteFromChord(Song.chords[0]),false, 100, Note.defaultOctave-2);
		for(int i = 1; i<trackRhythm.size(); i++){
			bassLine[i] = new Note(trackRhythm.get(i),pickNotePitchBass(bassLine[i-1].pitch,bassFlow.get(i)),false,100, Note.defaultOctave-2);
		}
	}
